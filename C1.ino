...
{
/*
 *  Εργασία A.4: Θέστε τον φωτεινό σηματοδότη σε λειτουργία
 */
...
/*
 *  Εργασία B: Θέστε το πεδίο ALERT σε 0
 */
...
/*
 *  Εργασία C.1: Διαβάστε το πεδίο ALERT και θέστε τον φωτεινό σηματοδότη σε ΠΟΡΤΟΚΑΛΙ αν η τιμή είναι 1
 */
